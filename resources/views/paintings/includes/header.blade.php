...
<head>
    ...
    <!-- Bootstrap Core Css -->
    <link href="{{asset('dashboard-asset/plugins/bootstrap/css/bootstrap.css')}}" rel="stylesheet">

    <!-- Waves Effect Css -->
    <link href="{{asset('dashboard-asset/plugins/node-waves/waves.css')}}" rel="stylesheet" />

    <!-- Animation Css -->
    <link href="{{asset('dashboard-asset/plugins/animate-css/animate.css')}}" rel="stylesheet" />

    <!-- Morris Chart Css-->
    <link href="{{asset('dashboard-asset/plugins/morrisjs/morris.css')}}" rel="stylesheet" />
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('index') }}">Rangrezz</a>
            </div>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="body">
                                <ul class="menu" style="list-style: none;">
                                    ...
                                    @livewire('show-notifications',['notification' => $notification])
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                ...
                                                <p>
                                                    <i class="material-icons">access_time</i> Checkout Later
                                                </p>
                                            </div>
                                        </a>
                                    </li>
